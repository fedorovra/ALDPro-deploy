        ...
        while True:
            ...
            if code == d.OK:
                ...
                tags = [ 
                        ...
                        { "name" : "resolv1", "progress" : 30, "status" : "В очереди", "skip" : True },
                        { "name" : "hostname", "progress" : 40, "status" : "В очереди", "skip" : False },
                        { "name" : "hosts", "progress" : 50, "status" : "В очереди", "skip" : False },
                        { "name" : "update", "progress" : 60, "status" : "В очереди", "skip" : True },
                        { "name" : "install-aldpro-mp", "progress" : 70, "status" : "В очереди", "skip" : True },
